...
//		Collections.sort(keyList);
	...
	public static CustomMap objectToCustomMap(
	        Object obj, 
	        String[] ignoredKeys, 
	        boolean isSuperContained, 
	        boolean isSimple) {
	    ...
	    for (Field field : fields) {
	        ...
	        try {
	            ...
	            if (isSimple && !isSimpleValue(value)) {
	...
	public static String objectToString(
	    ...
	    CustomMap objectToCustomMap = objectToCustomMap(obj, ignoredKeys, isSuperContained, isSimple);
	    
	    return objectToCustomMap.toString().replace("CustomMap", obj.getClass().getSimpleName());
	}
}
